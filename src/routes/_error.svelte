...
<main>
	<h2
		...
		{status}
		<br class="xl:hidden" />
		<span class="text-indigo-600">...obviously that happens</span>
	</h2>

	<p class="mt-4">
		The server responded with error
		<b class="font-bold">{error.message}</b>
		.
		<br />
		This may happen and you should not feel guilty about it. Life goes on.
	</p>
	...
	<div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
		<div class="rounded-md shadow">
			<a
				...
				Howsoever &hellip; go to the start page
			</a>
		</div>
